...
${OBJECTDIR}/_ext/5d8126cf/termlib.o: ../../../../termlib.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/5d8126cf/termlib.o ../../../../termlib.c

.NO_PARALLEL:${OBJECTDIR}/Main\ TP12.o
${OBJECTDIR}/Main\ TP12.o: Main\ TP12.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Main\ TP12.o Main\ TP12.c

${OBJECTDIR}/emuladordepuertos.o: emuladordepuertos.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/emuladordepuertos.o emuladordepuertos.c
